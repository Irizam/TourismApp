...
public class NavegateScript : MonoBehaviour
{
    ...
    void Start()
    {
        StartCoroutine("GetMap"); // llama para la ejecucion del metodo que traue los recursos del mapa
    }
